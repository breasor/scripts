Function Get-RandomString {
    ...
    .Parameter ExcludeList
        Includes characters and numbers to be excluded for whatever reason from the returned value.
    .PARAMETER Length
    ...
    foreach ( $E in $ExcludeList ) {
        ...
        $CharList = $CharList -cne $E
   }

    write-verbose ($CharList | out-string )
...
get-randomstring -length 8 -UpperCase -Numbers -ExcludeList 'l','1','o','0','O'