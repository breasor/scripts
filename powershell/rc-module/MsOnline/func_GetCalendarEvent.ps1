...
#>
	...
	PROCESS
	{
		...
		$Splatting = @{
            ...
            Uri = "https://outlook.office.com/api/v1.0/me/events?`$select=Subject,Organizer,Start,End"
		...
		if (-not $PSBoundParameters['EmailAddress'])
		{
            ...
            $splatting.Uri = "https://outlook.office.com/api/v1.0/me/events?`$select=Subject,Organizer,Start,End"
		}
