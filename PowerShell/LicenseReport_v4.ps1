...
process
{
	...
	#$MsolUsers | Export-Clixml c:\exploit\xml\AllMsolUser.xml -Depth 4
	$MsolUsers = Import-Clixml c:\exploit\xml\AllMsolUser.xml
	...
	#$Users | Export-Clixml c:\exploit\xml\AllUsers.xml
	$Users = Import-Clixml c:\exploit\xml\AllUsers.xml
	...
	#$Mailboxes | Export-Clixml c:\exploit\xml\AllMailbox.xml
	$Mailboxes = Import-Clixml c:\exploit\xml\AllMailbox.xml
	
	$UserAccounts = @{ }
	
	_GetUsers
	#$UserAccounts | Export-Clixml c:\exploit\xml\UserAccounts.xml
	
	$UserAccounts = Import-Clixml c:\exploit\xml\UserAccounts.xml
	...
	$Admins = _GetMsolRole
	$Admins | Export-Clixml c:\exploit\xml\Admins.xml
